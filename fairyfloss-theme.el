...
(let (
  ...
  (custom-theme-set-faces
   ...
   ;; Typography faces
   `(default ((t (:inherit nil :stipple nil :background "#5a5376" :foreground fairy-space-100 :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120)))))
